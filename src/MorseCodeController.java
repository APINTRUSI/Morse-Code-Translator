...
public class MorseCodeController {
    ...
    private void playBeep(SourceDataLine line, int duration){
        ...
        for(int i = 0; i < data.length; i++){
            ...
            double angle = i / (44100/440.0) * 2 * Math.PI;

            //calculates the amplitudeof the sint wave at the current angle and scale it to fit within the range of a single byte (-127, 127) alse in the context of audio processing, a singed bytes is often used to represent audio data because it can represent both positive and negative aplitudes of sound waves
            data[i] = (byte) (Math.sin(angle) * 127);
        }
        //write the audio dt in the data line to be played
